...
export const translation: Translation = {
  themeInstalled: 'Atom Material Icons wurde installiert.',
  howToActivate: 'Wie Icons aktivieren?',
  activate: 'Aktivieren',
  activated: 'Atom Material Icons ist jetzt aktiviert.',
  neverShowAgain: 'Nicht mehr zeigen',
  themeUpdated: 'Das Atom Material Icons wurde aktualisiert.',
